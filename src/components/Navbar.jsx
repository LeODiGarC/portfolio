...
export function Navbar() {
  ...
  return (
    <NavigationMenu className="hidden md:block fixed top-3 right-3 z-50 h-auto rounded-2xl w-auto px-4 md:px-6 py-2 border-b bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60">
